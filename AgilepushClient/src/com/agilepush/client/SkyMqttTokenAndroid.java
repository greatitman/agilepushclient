...
class SkyMqttTokenAndroid implements IMqttToken {
	...
	private SkyMqttAndroidClient client;
	 ...
	 * 
	 * @param client
	 *            used to pass MqttAndroidClient object
	 * @param userContext
	 *            used to pass context
	 * @param listener
	 *            optional listener that will be notified when the action
	 *            completes. Use null if not required.
	 */
	SkyMqttTokenAndroid(SkyMqttAndroidClient client, Object userContext,
	 ...
	 *            completes. Use null if not required.
	 * @param topics
	 *            topics to subscribe to, which can include wildcards.
	 */
	SkyMqttTokenAndroid(SkyMqttAndroidClient client, Object userContext,
			IMqttActionListener listener, String[] topics) {
		this.client = client;
	...
	public SkyMqttTokenAndroid(SkyMqttAndroidClient mqttAndroidClient,
